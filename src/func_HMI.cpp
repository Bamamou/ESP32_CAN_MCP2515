...
/******************************************************************************
 * func_HMI.cpp
 * This file has the code for the functions that prepares CAN packets to send to the HMI， Wu's version
 *****************************************************************************/
...
//  // Send Icon Signal Low byte (byte 0) Includes headlights, L R turn signals, reverse, N, kill and kickstand
...
//    HMISend4.writeByte(HMISend4_byteError4HighByte, (auxE4 & 0xFF));// added change to this to change the reading rom small to big endianv2
