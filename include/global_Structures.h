...
struct StructVehicleInfo
{
	...
	// Status flags
	uint8_t ridingMode = 2;				  // 0 = Eco, 1 = City, 2 = Pro. Starts in City   // wzh20230429 1 to 2
...
struct StructBMS
{
	...
	double avgBatteryTemperature = 0; // Temperatures 1, 2, 3 and 4
	...
	double Negetive_current = 0;

	double CycleTime = 0;

	uint8_t PackStatusHighByte = 0; // Not used

	uint8_t PackStatusLowByte = 0;  // Bit 7-Charging Status / Bit 6-Discharging Status/ Bit 1-Charging enable/ Bit 0-Discharging enable

	uint8_t ProtectionHighByte = 0; // Bit 2-Low temperature protection / Bit 1-High temperature protection/ Bit 0- Single cell undervoltage

	uint8_t ProtectionLowByte = 0; // Bit 7-Single cell overvolatge / Bit 6- Pack undervoltage / Bit 5- Pack overvoltage / Bit 4- Discharge overcurrent/ Bit 3- Charge overcurrent

	uint8_t ChargingContactorStatus = 0;

    uint8_t DischargingContactorStatus = 0;

	uint8_t NumberofVoltage = 0; // No used 

	uint8_t NumberofTemperature = 0;  // No used

	uint8_t AlarmHighestLevel = 0;  //  level 1,2,3 // Summarize the alarms level, show the highest level of alarm

	uint8_t BatteryChargingConditionsMeet = 0;  //  1  possible charge/ 0 protection

	uint8_t BatteryDischargingConditionsMeet = 0;  //  1  possible discharge/ 0 protection

	uint8_t TotalOvervoltageAlarm = 0; // level 1,2,3 // 1-warning/ 2-warning 2/ 3-trigger protection

	uint8_t SimpleOvervoltageAlarm = 0; // level 1,2,3 // 1-warning/ 2-warning 2/ 3-trigger protection

	uint8_t TotalUndervoltageAlarm = 0; // level 1,2,3 // 1-warning/ 2-warning 2/ 3-trigger protection

	uint8_t SimpleUndervoltageAlarm = 0; // level 1,2,3 // 1-warning/ 2-warning 2/ 3-trigger protection

	uint8_t DischargingHighTemperatureAlarm = 0; // level 1,2,3 // 1-warning/ 2-warning 2/ 3-trigger protection

	uint8_t ChargingHighTemperatureAlarm = 0; // level 1,2,3 // 1-warning/ 2-warning 2/ 3-trigger protection

	uint8_t DischargingLowTemperatureAlarm = 0; // level 1,2,3 // 1-warning/ 2-warning 2/ 3-trigger protection

	uint8_t ChargingLowTemperatureAlarm = 0; // level 1,2,3 // 1-warning/ 2-warning 2/ 3-trigger protection

	uint8_t DischargingOverCurrentAlarm = 0; // level 1,2,3 // 1-warning/ 2-warning 2/ 3-trigger protection

	uint8_t ChargingOverCurrentAlarm = 0; // level 1,2,3 // 1-warning/ 2-warning 2/ 3-trigger protection

	uint8_t AbnormalDischargingAlarm = 0; // level 1,2,3 // 1-warning/ 2-warning 2/ 3-trigger protection

	uint8_t AbnormalChargingAlarm = 0; // level 1,2,3 // 1-warning/ 2-warning 2/ 3-trigger protection

    uint8_t batteryPhysicalCapacity = 0;
    uint8_t batteryRemainingCapacity = 0;
